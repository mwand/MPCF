...
(* | constexp : forall {m} {X : Type}, X -> Val G (Stype m) *)
...
| distval : Val G (Stype Real_type) -> Val G (Meastype Real_type)
(* some non-uniform distribution: *)

| obsval : Val G (Stype Real_type)
           -> Val G (Stype Real_type)
           -> Val G (Meastype Empty_type)
(* obsval r x is a Meas() representing the weight of observing x with
                         likelihood given by the pdf of (mu_1 r) *)
...
| unitval : Val G (Stype Empty_type).
