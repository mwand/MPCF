(* Adequacy for a pure CBV LC *)
(* Here we'll play with implicit arguments to get the clearest *)
(* possible code *)

(* Also do without Set Implicit Arguments and Set Asymmetric Patterns *)
...
Lemma extend_env_preserves_Rel :
  forall (o: Otype) G r (s : Subst G nil) (d : den_type o) (val: Val nil o),
    Rel_Env G r s -> Rel o d val
    -> Rel_Env (o :: G) (cons_env d r) (cons_subst val s).
Proof.
  intros.
  simpl.
  split.
...
Proof.
  ...
  assert (Rel_Env (o :: G) (cons_env a1 r) (cons_subst val2 s)).
