...
(* First task: get it working without Set Implicit Arguments, Set *)
(* Asymmetric Patterns. *)
...
Arguments valexp {_ _} _.
Arguments appexp {_ _ _} _ _.
Arguments bindexp {_ _ _} _ _.
Arguments returnexp {_ _} _.
Arguments constexp {_} _.
Arguments varexp {_ _} _.
Arguments absexp {_ _ _} _.
Arguments uniformval {_}.
Arguments bindval {_ _ _} _ _.
Arguments returnval {_ _} _.
...
| evs_unif : forall u,
               evs u (uniformval) (constexp (unit_real u))
...
Arguments evs_unif {_}.
Arguments evs_return {_ _ _}.               
Arguments evs_bind {_ _ _ _ _ _ _ _}_ _ _.
...
Lemma unif_preserves_Rel :
  MeasRel Rel uniformop uniformval.
Proof.
  unfold MeasRel.
  intros.
  unfold uniformop.
